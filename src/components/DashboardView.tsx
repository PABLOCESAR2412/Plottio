...
const DASHBOARD_WIDGETS: { id: string; label: string }[] = [
	...
	{ id: "recentOrders", label: "Órdenes recientes" },
	{ id: "todayCitas", label: "Citas de hoy" },
...
export const DashboardView: React.FC<DashboardViewProps> = ({
	...
	const showTodayCitas = visibleWidgets.includes("todayCitas");
	const showQuickActions = visibleWidgets.includes("quickActions");
	...
	return (
		<div className="space-y-6">
			...
			{(showRecentOrders || showTodayCitas) && (
							...
							{todayCitasCount > 0 && (
								<div className="mt-4 pt-3 border-t border-border">
									<p className="text-xs text-muted-foreground text-center font-medium">
										Tienes {todayCitasCount} compromisos agendados para este
										día.
									</p>
								</div>
							)}
